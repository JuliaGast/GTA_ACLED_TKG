...
class Trainer(object):
    ...
    def save_model(self, model_name=None, checkpoint_path='checkpoint.pth'): #added julia:model name
        """Save the parameters of the model and the optimizer,"""
        # argparse_dict = vars(self.args)
        # with open(os.path.join(self.args.save_path, model_name+'config.json'), 'w') as fjson:
        ...
        torch.save({
            ...
            os.path.join(self.args.save_path, model_name+checkpoint_path)
        )
