...
parser.add_argument("--dataset", "-d", default="regcn_icews14", type=str)
parser.add_argument("--test_data", default="test", type=str)
parser.add_argument("--candidates", "-c", default="250422122451_r[1,2,3]_n200_exp_s12_cands_r[1,2,3]_w-1_score_12[0.1,0.5].json", type=str)
