...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', default='Timetraveller/TITer-master/data/ICEWS14', type=str) # modified julia: adde Timetraveller/TITer-master/
    parser.add_argument('--outfile', default='dirchlet_alphas.pkl', type=str)
    parser.add_argument('--k', default=305, type=int) # modified julia: was 300, is now 305 to cover all train timesteps for our icews14 version
