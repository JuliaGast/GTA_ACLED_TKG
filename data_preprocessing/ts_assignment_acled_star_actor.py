...
#  *
#  *        File: ts_assignment_acled_star_actor.py
#  *
...
if name =='acled_collapsed':
    ...
    g.parse(data="./../data/raw/acled_2023_collapsed_actors.nt", format = "ntstar") 
...
with open('./../data/acled/acled_2023_actors.csv', 'w', newline='') as csvfile:
